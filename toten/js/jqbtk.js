                ...
                default:
                    ...
                    if(variavel == 'data'){
                        ...
                        switch(currentContent.length){
                            case 2:
                                if(currentContent.substr(0, 2) == 00 || currentContent.substr(0, 2) > 31){

                                    currentContent = currentContent.substr(0, currentContent.length - 2);
                                ...
                                break;
                            case 5:
                                if(currentContent.substr(3, 2) == 00 || currentContent.substr(3, 2) > 12 ){
                            ...
                            case 10:
                                 ...
                                 if((currentContent.substr(3, 2) == 04 || currentContent.substr(3, 2) == 06 || currentContent.substr(3, 2) == 09 || currentContent.substr(3, 2) == 11)&&currentContent.substr(0, 2) == 31){

                                     currentContent = currentContent.substr(0, currentContent.length - 7);

                                 }else if(currentContent.substr(3, 2) == 02 && (currentContent.substr(0, 2) > 29 || (currentContent.substr(0, 2) == 29 && currentContent.substr(6, 4) % 4 != 0))){

                                     currentContent = currentContent.substr(0, currentContent.length - 7);

                                 }else if(currentContent.substr(6, 4) <= 1900){

                                    currentContent = currentContent.substr(0, currentContent.length - 4);
                                ...
                                break;
                            case 13:
                                if(currentContent.substr(10,3) >= 00 && currentContent.substr(10,3) <= 23){
                                ...
                                break;
                            case 16:
                                if(currentContent.substr(14,2) >= 00 && currentContent.substr(14,2) <= 59){

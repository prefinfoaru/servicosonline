          ...
          <section class="wrapper">
              ...
              <div class="row">
               ...
               <!--   	<div class="row mtbox">
                      ...
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                  ...
                                  <th><i class=" fa fa-edit"></i> Evolução Votos (6 Membros)</th>
                            ...
                            <?php
                                ...
                                if ($idJurado == 'J_7')       {                                      
                                  $sql  = "SELECT * FROM bd_epda.tb_requerimento where J_7 = '0' and ataCriada = '0' "; }
                                 ...
                                 $p = round($procetresultss, 1).'%' ; 
                                  ...
                                  aria-valuenow='40' aria-valuemin='0' aria-valuemax='50' style='width:$p'>
                                  Votos $valor1ps"." - "." total de "."$p
                                  </div>
                                  </div>	"				 . '</td>';
                                  ...
                                  <a href =?p=dadosrespostasmesa&?protocolo='.$row["protocolo"].' ><button class="btn btn-defaut btn-xs"  title="Vizualizar Observações"><i class="fa fa-eye-slash"></i></button></a>
                                  <a href =?p=dadosrespobs&?protocolo='.$row["protocolo"].' ><button class="btn btn-defaut btn-xs"  title="Incluir Observações"><i class="fa fa-eye"></i></button></a>
                                  <a href =?p=montagemata&?protocolo='.$row["protocolo"].' ><button class="btn btn-success btn-xs"  title="Julgar"><i class="fa fa-check"></i></button></a>'
                                  . '</td>';
                  ...
                  </div></div><br><br><br><br><!-- /col-lg-9 END SECTION MIDDLE -->

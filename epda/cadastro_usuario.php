...
<div class="container">
    <div class="row">
        ...
        <div align="center">
            <h2 style="color:#114A6F ; font-size: 15px;"><img src="assets/img/brasao.png" width="50px" height="70px"><br>EPDA<br> <i style="font-size: 10px">(Escritório Plano Diretor de Arujá)</i></h2>
        </div>
                    ...
                    <div class="panel-body">
                        ...
                        <form action="salva_cadastro.php" method="post" required>
                            <div class="row">
                                ...
                                <div class="col-xs-4">
                                    <label>CPF:</label>
  <br>                                <input class="form-control" id="cpf" name="cpf" type="text" onkeyup="cpfCheck(this)" maxlength="18" onkeydown="javascript: fMasc( this, mCPF );"> 

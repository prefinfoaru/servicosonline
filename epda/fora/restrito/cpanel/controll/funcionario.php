...
<div class="container">
    ...
    <div class="container">
        ...
        if ($filtro == "todos") {
            $sql = $pdo->query("SELECT * FROM tb_solicitacao where tb_situacao <>1 AND tb_nome_funcionario = '$funcionario' AND tb_data_status between '$datai' AND '$dataf' ORDER BY tb_nome_funcionario ASC");
        } else {
            $sql = $pdo->query("SELECT * FROM tb_solicitacao where tb_situacao ='$filtro' AND tb_nome_funcionario = '$funcionario' AND tb_data_status between '$datai' AND '$dataf' ORDER BY tb_nome_funcionario ASC");
        }
            ...
            <tbody>
                <tr>
                    ...
                    if ($sql->rowCount() >= 1) {
                        ...
                        <div align="center"><br>
                            <label style="font-family: consolas">Não há informação para este funcionario neste periodo</label></div>
                        <br>
                    <?php
                    }
                    ?>

...
<div class="container">
    <div class="row">
        ...
        <div align="center">
            <h2 style="color:#114A6F ; font-size: 15px;"><img src="cpanel/img/brasao/brasão.png" width="50px" height="70px"><br>SG<br> <i style="font-size: 10px">(Acesso ao Sistema de Solicitação de Hora Extra)</i></h2>
        </div>

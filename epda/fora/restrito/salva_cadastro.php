...
$querycadastro =  "INSERT INTO `bd_sol_hr`.`tb_cadastro_de_usuarios` (`matricula`, `nome`, `funcao`, `regime`, `cargahoraria`, `tel`, `email`, `senha`, `nivel`, `data_cadastro`) VALUES ('$matricula', '$nome', '$funcao', '$regime', '$carga', '$tel', '$email', '$hash', '3', '$data');";

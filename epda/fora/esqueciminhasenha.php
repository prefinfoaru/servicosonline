...
<div class="container">
    <div class="row">
    	...
    	<div align="center"> 
<h2  style="color:#114A6F ; font-size: 15px;"><img src="cpanel/img/brasao/brasão.png" width="50px" height="70px"><br>SGDER<br> <i style="font-size: 10px">(SISTEMA DE PLANEJAMENTO DE FÉRIAS)</i></h2>
</div> 
                    ...
                    <div class="panel-body">
                        ...
                        <form action="upload_senha_provissoria.php" method="post">
                           <div class="col-xs-5">
                                ...
                                <input type="text" class="form-control" name= "usuario" placeholder="Digite sua Matrícula">

...
<i class="fas fa-chalkboard-teacher"></i><i class="fas fa-chalkboard-teacher"></i> <!--main content start-->
    ...
    <div class="form-group" align="center"><br>
     <h4>Análise do Requerimento com nº de Protocolo : <b style="color: indianred"><?php echo 'epda'. $ProtocoloRequerimento; ?></b></h4><hr>
        <h7>Selecione uma opção abaixe para Votação.</h7><br><br><br>
   <form action="./consulta/uploadrespdadosdef.php" method="post" >
    
       
       <div class="radio">
						  <label>
						    <input type="radio" name="optionsRadios" id="optionsRadios1" value="1" checked>
						   <strong style="color: green"> Deferir </strong><br>Declaro que Jugo Procedente a Solicitação do Requerente com nº de Protocolo <?php echo 'epda'. $ProtocoloRequerimento?> por isso defiro o Requerimento.<hr>
						  </label>
						</div>
						<div class="radio">
						  	  <label>
						    <input type="radio" name="optionsRadios" id="optionsRadios1" value="2" checked>
						   <strong style="color: red"> indeferir </strong><br>Declaro que Jugo Inprocedente a Solicitação do Requerente com nº de Protocolo <?php echo 'epda'. $ProtocoloRequerimento?> por isso indefiro o Requerimento.<hr>
						  </label>
						</div>
    ...
    <a href="http://servicosonline.prefeituradearuja.sp.gov.br/servicosonline/epda/cpanelmebros/index.php?p=home" onclick="javascript:window.open('', '_self', '').close()"><button class="btn btn-warning" type="button">Voltar</button></a>
        </div>

...
<!-- Multiple Radios (inline) -->
  ...
  <label class="col-md-12 control-label" for="radios" style="text-align: center">Caso seja necessário o envio de notificações referente a este requerimento, autorizo que as mesma sejam enviuadas através do email informado nos dados pessoais: <h11>*</h11></label>

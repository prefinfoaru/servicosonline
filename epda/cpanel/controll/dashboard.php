                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Controle de Solicitações</h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  ...
                                  <th style="text-align: center "><i class="fa fa-cog fa-spin"></i> Ações</th>
                            ...
                            <?php
                                  include "conexao.php";
                                  $pdo  = Banco::conectar();                                  
                                  $sql  = "SELECT  *FROM bd_epda.tb_requerimento order by  dt_cadastro desc";
                               ...
                               $jurado_6 = $row['J_7'];
                               $valorTotal = 7 ;
                               $valor1ps   = $jurado_1 + $jurado_2 + $jurado_3 + $jurado_4 + $jurado_5 + $jurado_6 + $jurado_6;       
                                ...
                                '<a href =?p=dadosRequerimento&?protocolo='.$row["protocolo"].' ><button class="btn btn-primary btn-xs"  title="Acessar os Dados"><i class="fa fa-folder-open"></i></button>
                                      </a>'

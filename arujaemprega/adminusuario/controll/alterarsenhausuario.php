...
swal.fire({
    ...
    icon: "success",
    html: '<hr><button  class="btn btn-default"><a style="color:#000" href="?p=alterarsenhausuario">OK</button></a>',
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="100">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#pablo">Menu Currículo</a>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Consultar Usuário (Alterar senha) </h4>
                                    ...
                                    <form action="" method="post">
                                        <div class="form-input">
                                            <div class="col-md-4 pl-1">
                                                ...
                                                <button type="submit"
                                                    class="btn btn-info btn-fill pull-right cursor">Consultar
                                            </div>
                                            </button>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 pl-1">
                                            ...
                                            <a href="?p=dadosaltersenhausunorm&idusu=<?php echo $id ; ?>">

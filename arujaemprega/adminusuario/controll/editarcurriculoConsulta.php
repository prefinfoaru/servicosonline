...
<?php 
include "./includes/topo_editarcadConsulta.php ";
 ...
 <br>
  ...
  <form action="" method="post">
    <div class="form-input">
                       ...
                       <button type="submit" name="Cadastrar" class="btn btn-info btn-fill pull-right cursor" title="Consultar CPF">Consultar </div>
        </button>
                        </div>
                                ...
                                <p style="color:#44A865"><i class="nc-icon nc-zoom-split" style="color:#44A865">  Resultado da Busca</i></p>                                
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 pl-1">
                                                ...
                                                <a href="?p=editar_cv&idcpfcon=<?php echo $id ; ?>">
                                                <i class="nc-icon nc-zoom-split" style="color: #BB5153 ; font-family:" title="Editar"> Editar </i></a>
                                                <?php } ?>

...
<?php
include "./../adminusuario/includes/topo_consultardadosCad.php ";
?>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Consultar Dados Cadastrados </h4>
 ...
 <br>
  ...
  <form action="" method="post">
    <div class="form-input">
                       ...
                       <button type="submit" name="Cadastrar" class="btn btn-info btn-fill pull-right cursor" >Consultar </div>
        </button>
                        </div>

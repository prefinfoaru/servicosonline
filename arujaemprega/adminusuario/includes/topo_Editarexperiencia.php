...
swal.fire({
    ...
    icon: "success",
    html: '<hr><button  class="btn btn-default"><a style="color:#000" href="?p=experienciasprofissionais&id=<?php echo $id ?>&?saida=1">OK</button></a>',
...
swal.fire({
    ...
    html: '<p>Por favor, tente novamente.</p><hr><button  class="btn btn-default"><a style="color:#000" href="?p=experienciasprofissionais&id=<?php echo $id ?>&?saida=1">OK</button></a>',
    showConfirmButton: false,
    allowOutsideClick: false
});
</script>

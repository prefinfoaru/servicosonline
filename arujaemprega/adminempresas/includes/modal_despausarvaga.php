...
<div class="modal fade modal modal-primary" id='myModal6<?php echo $id_vaga ?>' tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" title="">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header justify-content-center">
                                   <h6 style="color:#235C26"> <i class='fa fa-check-square'></i> - Reativar Vaga:  <?php echo $id_vaga ?></h6>
                                </div>
                                <div class="modal-body text-center">
                                    <p style="font-size: 16px; color:#000"><strong><i>DESEJA REALMENTE REATIVAR ESSA VAGA?</i></strong></p><hr>
                                   
                                    <form action="./data/update/despausar_vaga.php" method="post">

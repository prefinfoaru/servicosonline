...
<div class="modal fade modal modal-primary" id='myModal4<?php echo $id_vaga ?>' tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" title="">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header justify-content-center">
                                   <h6 style="color:#235C26"> <i class='fa fa-check-square'></i> - Liberar Vaga para Candidatos:  <?php echo $id_vaga ?></h6>
                                </div>

								...
								<div class="card-header">
                                   ...
                                   <!-- <form action="?p=curriculo_pdf" method="post" target="_blank"> -->
									...
									<?php 
											...
											echo '<a href="?p=menu_editarvagas&?id='.$id_vaga.'"><button type="button" class="btn btn-warning btn-fill pull-center cursor" title="Voltar para lista de candidaturas">VOLTAR</button></a>';

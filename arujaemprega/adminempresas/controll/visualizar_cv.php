								...
								<div class="row">
									...
									foreach ($pdo->query($select_formacao_acadmc) as $formacao_acadmc) {
										...
										if ($formacao_acadmc['conclusao_mes'] != '') {
											...
											echo '<p class="text-muted">Trancado</p>';
										}
										echo '</div>';
										echo '</div>';
										echo '<div class="col-md-4 pl-1">';
							...
							<div class="row">
								...
								if ($count_dados == '0') {
									...
									foreach ($pdo->query($select_ex_profissionais) as $ex_profissionais) {
										...
										echo '<div class="form-group typography-line">';
										echo '<h6>CARGO</h6>';
										echo '<p class="text-muted">' . $ex_profissionais['cargo'] . '</p>';
										echo '</div>';
										echo '</div>';
					...
					<div class="card card-user">
						...
						<div class="card-body">
							<div class="author">
								...
								<img class="avatar border-gray" src="<?php if(!isset($tratado)){echo './imagens/perfil.jpg';}else{echo './../adminusuario' . $tratado;} ?>" alt="...">
							...
							if (empty($nis)) {
								...
								echo '<h6>NÚMERO DO NIS</h6>';
								echo '<p class="text-muted">' . $nis . '</p>';
							}
							?>

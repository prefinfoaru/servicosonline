...
$id_solicitante	=	$_GET['soli'];

$select_cad_soli		 =	"SELECT * FROM bd_emprega_aruja.tb_cadastro_solicitante where id_solicitante = '$id_solicitante' ";

$select_nis		 		 =	"SELECT * FROM bd_emprega_aruja.tb_nis where id_solicitante = '$id_solicitante' and id_vaga = '$id_vaga' ";

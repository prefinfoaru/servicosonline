...
$obrigatorio		= 	utf8_decode($_POST['obrigatorio'])	;
            ...
            if(mysqli_insert_id($conn)){ //sucesso
				...
				header('Location: https://servicosonline.prefeituradearuja.sp.gov.br/servicosonline/arujaemprega/adminempresas/index.php?p=dadosInformaticaVaga&id='.$idvaga.'');
				
			} else { //erro ao cadastrar 
			
				header('Location: https://servicosonline.prefeituradearuja.sp.gov.br/servicosonline/arujaemprega/adminempresas/index.php?p=dadosInformaticaVaga&id='.$idvaga.'');
				$_SESSION['errocadinfor']=2;

...
//********************************************************************************************************************************************************************************************
$query_con_cpf = "SELECT * FROM bd_emprega_aruja.tb_cadastrousuario_restrito where cpf = '$cpf'";
...
swal.fire({
    ...
    icon: "success",
    html: '<hr><button  class="btn btn-default"><a style="color:#000" href="?p=excluirusupre">OK</button></a>',
...
swal.fire({
    icon: 'error',
    title: '<strong>Exclusão não realizada!</strong>',
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="card-category">Àrea para exclusão de usuário
                        ...
                        <div class="container">
                            <br>
                            <p style="color: #3E3E3E">Por favor Digite um CPF válido para verificarmos o cadastro em
                            ...
                            <div class="row">
                                <div class="col-md-5 pr-1">
                                    <div class="form-group">
                                        <label>Função</label>
                                        <input type="text" class="form-control" disabled=""
                                            value="<?php  if (empty($funcao)){echo "..." ;}else {echo $funcao;} ?>">
                                    </div>
                                </div>
                                <div class="col-md-5 pr-1">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2 pr-1">
                                    ...
                                    <a href="data/delete/excluirusupma.php?id=<?php    echo    $id; ?>"
                                        data-confirm='Tem certeza que deseja exluir esse usuário?'>
                                        <button type="submit" class="btn btn-danger btn-sm btn-fill ">Excluir</button>
                                        <?php } ?>
                                    </a>
                                ...
                                <script src="./assets/js/caixaconfirmaexcluir.js" type="text/javascript"></script>
                            </div>

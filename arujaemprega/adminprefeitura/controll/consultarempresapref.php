...
<div class="main-panel">
    ...
    <nav class="navbar navbar-expand-lg " color-on-scroll="100">
        <div class="container-fluid">
            <a class="navbar-brand" href="#pablo">Menu Empresas -> Consulta Empresa</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="container">
                            <br>
                            <p style="color: #3E3E3E">Por favor digite o CNPJ cadastrado para que possamos buscar os
                                dados.</p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 pl-1">
                                    ...
                                    <a href="./../adminempresas/data/valida/validalogin.php?id=<?php echo $cpf ; ?>">

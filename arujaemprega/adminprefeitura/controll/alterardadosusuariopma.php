...
swal.fire({
    ...
    icon: "success",
    html: '<hr><button  class="btn btn-default"><a style="color:#000" href="?p=alterdadosusup">OK</button></a>',
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Consultar Usuário da Prefeitura (Alterar dados) </h4>
                                    <p class="card-category">Àrea para acesso do responsavél pelo Arujá Emprega, onde é
                                        possivel alterar os dados do usuário.
                                    </p>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 pl-1">
                                            ...
                                            <a href="?p=dadosalterdadosusu&idusu=<?php echo $id ; ?>">
                                                <i class="nc-icon nc-zoom-split"
                                                    style="color: #BB5153 ; font-family:">Editar</i></a>
                                            <?php } ?>

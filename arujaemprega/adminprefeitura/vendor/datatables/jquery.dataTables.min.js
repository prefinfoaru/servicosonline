...
(function (h) {
  ...
  function K(a, b, c, d) {
    ...
    d &&
      (c +=
        '. For more information about this error, please see ://datatables.net/tn/' +
        d);
  ...
  n.defaults = {
    ...
    oLanguage: {
      ...
      sInfo: 'Mostrando _START_ de _END_ dos _TOTAL_ registros',
      sInfoEmpty: 'Mostrando 0 de 0 dos 0 registros',

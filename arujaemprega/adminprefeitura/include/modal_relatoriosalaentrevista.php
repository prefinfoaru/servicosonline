...
<form method="post" action="?p=relatorio_salaentrevista">
<div class="modal fade  modal-primary" id="ModalSalaEntrevista" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false" style="background-color: rgba(0, 0, 0, 0.5);">
	<div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
				...
				<label class="radio-inline"><input type="radio" name="tipo" value="2">&nbsp;Reprovado</label>&nbsp;&nbsp;
				<label class="radio-inline"><input type="radio" name="tipo" value="0">&nbsp;Em Aguardo</label>&nbsp;&nbsp;
				<label class="radio-inline"><input type="radio" name="tipo" value="3">&nbsp;Cancelado</label>&nbsp;&nbsp;

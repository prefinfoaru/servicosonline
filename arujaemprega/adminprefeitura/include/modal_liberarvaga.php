...
<div class="modal fade modal modal-primary" id='myModal4<?php echo $row_transacoes['id_vaga']; ?>' tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" title="">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header justify-content-center">
                                   <h6 style="color:#235C26"> <i class='fa fa-check-square'></i> - Liberar Vaga para Candidatos:  <?php echo $row_transacoes['id_vaga']; ?></h6>
                                </div>
                                <div class="modal-body text-center">
                                    <p style="font-size: 16px; color:#000"><strong><i>DESEJA REALMENTE LIBERTAR ESSA VAGA?</i></strong></p><hr>
                                    <p style="font-size: 14px; color:#000"><i>Depois de liberada não será possível editar!</i></p><hr>
                                   
                                    <form action="./data/update/liberar_vaga.php" method="post">
                                   ...
                                   <!--   <label for="sel1">Qual motivo da exclusão da vaga ?</label>
                                    ...
                                    <input type="hidden" value="<?php echo $row_transacoes['id_vaga'];?>" name="id">

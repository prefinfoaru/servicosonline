      ...
      <section id="contact" class="contact section-bg">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
            ...
            <p>
              Digite o CPF no campo abaixo para realizar o cancelamento do seu agendamento.
            </p>
          </div>

          <div class="row php-email-form" >
            <div class="col-md-12" >
              <form name="verifica_agendamento" id="form_cancela" action="cancela_consulta.php" method="POST" class="">
              <div class="row "  >

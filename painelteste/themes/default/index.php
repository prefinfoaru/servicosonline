<div id="layout-content">
    ...
    <div id="barra-lateral">
        ...
        <div id="relogio-container">
            <iframe id="relogio" src="http://servicosonline.prefeituradearuja.sp.gov.br/servicosonline/painelteste/themes/default/relogio/index.htm" frameborder="0" scrolling="no"></iframe>
        </div>
    </div>
    <div id="historico">
        <div class="senhas">
